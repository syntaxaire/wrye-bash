...
from gui.buttons import BackwardButton, Button, CancelButton, ForwardButton, \
    OkButton, ReloadButton
from gui.layouts import HBoxedLayout, HLayout, LayoutOptions, Stretch, \
    VLayout, TOP, RIGHT
from gui.text_components import Label, TextArea
from gui.webview import web_viewer_available, WebViewer
        ...
        if self.dragging != wx.NOT_FOUND:
            ...
            if released != wx.NOT_FOUND:
                evt = wx.CommandEvent(wx.wxEVT_COMMAND_BUTTON_CLICKED,
                                      button._native_widget.GetId())
                wx.PostEvent(button._native_widget, evt)
        event.Skip()
